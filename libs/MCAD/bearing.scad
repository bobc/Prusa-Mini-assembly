                ...
                material=Steel, sideMaterial=Brass) 
{
  ...
  union() 
  {
      ...
      {
        // Basic ring
        Ring([0,0,0], outerD, innerD, w);

        if (outline==false) 
        {
          // Side shields
          Ring([0,0,-epsilon], outerRim, innerRim, epsilon+midSink);
          Ring([0,0,w-midSink], outerRim, innerRim, epsilon+midSink);
        }
      }
